...
################################################################################
## Form generated from reading UI file 'groupbas.ui'
##
...
class Ui_CoordWidget(object):
    def setupUi(self, CoordWidget):
        ...
        self.btn_buy = QPushButton(self.groupBox)
        self.btn_buy.setObjectName(u"btn_buy")
        sizePolicy1.setHeightForWidth(self.btn_buy.sizePolicy().hasHeightForWidth())
        self.btn_buy.setSizePolicy(sizePolicy1)
        icon = QIcon()
        icon.addFile(u":/icons/check.png", QSize(), QIcon.Normal, QIcon.Off)
        self.btn_buy.setIcon(icon)
        self.btn_buy.setIconSize(QSize(50, 50))

        self.horizontalLayout.addWidget(self.btn_buy)
        ...
        icon1 = QIcon()
        icon1.addFile(u":/icons/cross.png", QSize(), QIcon.Normal, QIcon.Off)
